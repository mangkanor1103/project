...
// Simulated credentials (replace with database lookup in a real application)
$valid_username = "superadmin";
$valid_password = "password123"; // In a real application, passwords should be hashed
...
<main class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-md rounded-lg p-6 max-w-md w-full">
        <h1 class="text-3xl font-bold text-blue-600 mb-6 text-center">Super Admin Login</h1>
