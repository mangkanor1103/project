...
<main class="bg-gradient-to-br from-blue-50 to-gray-100 min-h-screen py-10">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">PHP
                            <?php echo number_format($stats['pending_amount'] ?? 0, 2); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">PHP
                            <?php echo number_format($stats['approved_amount'] ?? 0, 2); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">PHP
                            <?php echo number_format($stats['reimbursed_amount'] ?? 0, 2); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">PHP
                            <?php echo number_format($stats['total_amount'] ?? 0, 2); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="GET" action="" class="flex flex-wrap gap-4 items-end">
                <div>
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="Approved" <?php echo $filter_status === 'Approved' ? 'selected' : ''; ?>>Approved
                        </option>
                        <option value="Rejected" <?php echo $filter_status === 'Rejected' ? 'selected' : ''; ?>>Rejected
                        </option>
                        <option value="Reimbursed" <?php echo $filter_status === 'Reimbursed' ? 'selected' : ''; ?>>
                            Reimbursed</option>
                    </select>
                </div>
            ...
            <?php if ($expense_result->num_rows > 0): ?>
                ...
                <form method="POST" action="" id="reimbursementForm">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <?php if ($expense['status'] === 'Approved'): ?>
                                                <input type="checkbox" name="expense_ids[]" value="<?php echo $expense['id']; ?>"
                                                    class="expense-checkbox rounded border-gray-300 text-blue-600 shadow-sm">
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo htmlspecialchars($expense['full_name']); ?></div>
                                            <div class="text-xs text-gray-500">ID:
                                                <?php echo htmlspecialchars($expense['emp_number']); ?></div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                <?php echo date('M d, Y', strtotime($expense['expense_date'])); ?></div>
                                            <div class="text-xs text-gray-500">Submitted:
                                                <?php echo date('M d, Y', strtotime($expense['created_at'])); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <button type="submit" name="mark_reimbursed" id="markReimbursedBtn"
                            class="bg-green-600 text-white px-4 py-2 rounded-md shadow-md hover:bg-green-700 transition disabled:opacity-50 disabled:cursor-not-allowed">
    ...
    <div id="detailsModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full"
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 max-w-md shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <h3 class="text-lg leading-6 font-medium text-gray-900 text-center mb-4" id="detailsTitle">Expense
                    Details</h3>
