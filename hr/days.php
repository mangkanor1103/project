...
requirePermission('manage_work_preferences');
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-4">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="work_days" value="22" class="form-radio text-blue-600"
                                        checked>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-4">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="radio" name="payment_frequency" value="Semi-Monthly"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    ...
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="bulk_work_days" value="22"
                                                class="form-radio text-blue-600" checked>
                                            <span class="ml-2">22 Days</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="bulk_work_days" value="26"
                                                class="form-radio text-blue-600">
                                            <span class="ml-2">26 Days</span>
                                        </label>
                                    </div>
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <div class="flex space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="bulk_payment_frequency" value="Monthly"
                                                class="form-radio text-blue-600" checked>
                                            <span class="ml-2">Monthly</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="bulk_payment_frequency" value="Semi-Monthly"
                                                class="form-radio text-blue-600">
                                            <span class="ml-2">Semi-Monthly</span>
                                        </label>
                                    </div>
                                ...
                                <div id="bulk-pay-days" class="mb-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="bulk_pay_day_1" id="bulk_pay_day_1" min="1" max="31"
                                            value="15"
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    </div>
                                    ...
                                    <div id="bulk-pay-day-2-container" class="mb-4 hidden">
                                        ...
                                        <input type="number" name="bulk_pay_day_2" id="bulk_pay_day_2" min="1" max="31"
                                            value="30"
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    </div>
                                </div>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                <?php echo htmlspecialchars($employee['department']); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <?php if ($paymentFreq == 'Semi-Monthly'): ?>
                                                <div class="text-xs text-gray-500">
                                                    Days: <?php echo $employee['pay_day_1']; ?> &
                                                    <?php echo $employee['pay_day_2']; ?>
                                                </div>
                                            <?php else: ?>
                                                <div class="text-xs text-gray-500">
